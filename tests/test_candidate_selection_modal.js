...
// 4. Check slot_card.js handler and badge delegation
assert.ok(slotCardJs.includes("'view-candidates':"), 'view-candidates action handler must exist');
assert.ok(slotCardJs.includes('data-badge="candidate-selection"'), 'candidate-selection badge click must exist');
